 ...
 * @author xeon
 */
public class FourierSeries extends javax.swing.JFrame {
    Main main;
    /**
     * Creates new form ComplexNumberASYS
     */
    public FourierSeries(Main main) {
        initComponents();
        this.main = main;
    }
    ...
    private void initComponents() {
        ...
        lblComplexNumbers.setText("Series de Fourier");
        pnlComplexNumbers.add(lblComplexNumbers, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 20, 320, 50));
        ...
        lblTema1.setText("Tema 2. Señales periodicas: Series de Fourier");
        ...
        pnlComplexNumbers.add(lblIndicacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 140, 280, 20));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FourierSeries.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
