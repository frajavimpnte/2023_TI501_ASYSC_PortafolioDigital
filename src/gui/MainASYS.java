...
public class MainASYS extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lbASYSC.setText("Portafolio Digital 2023 ITESS-TICS ASYSC");
        lbASYSC.setToolTipText("");
        bg.add(lbASYSC, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 10, 500, 40));

        bgLogo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/backgraund_test.png"))); // NOI18N
        bg.add(bgLogo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 364, 500));

        lblTema2.setText("Tema2. Series de Fourier");
        bg.add(lblTema2, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 190, -1, -1));

        lblTema1.setText("Tema1. Introuducción");
        bg.add(lblTema1, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 190, 120, -1));

        lblTema3.setText("Tema3. Series de Fourier");
        ...
        bg.add(TransformFourier, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 220, 110, 90));
        ...
        jLabel1.setText("Francisco Javier Montecillo Puente");
        bg.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 50, 260, -1));
    ...
    private void NumerosComplejosMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_NumerosComplejosMouseExited
        NumerosComplejos.setBackground(Color.white);
